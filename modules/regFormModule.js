...
const creatingRegForm = () => {
  const mainLoginFormContainer = document.querySelector(
    ".mainLoginFormContainer"
  );
  mainLoginFormContainer.innerHTML = `<div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card">
                <h2 class="card-title text-center">Prisijunkite!</h2>
        ...
        <div class="col-md-4 reg-form">
            <div class="card">
                <h2 class="card-title text-center">Registruokitės!</h2>
                <div class="card-body py-md-4">
                    <form>
                        <div class="form-group">
